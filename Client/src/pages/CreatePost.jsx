  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        [500px]'>create imaginative and visual images through DALL-E AI
        </p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          border-gray-300 text-gray-300 text-gray-900 text-sm rounded-lg
          focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 p-3
        ...
        <div className='mt-10'>
          ...
          <button
          type='submit'
          className='mt-3 text-white bg-[#6369ff]
